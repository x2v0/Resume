...
PHENIX, Minos (USA)
ATLAS, Alice (CERN)
Автор ~80 научных работ с индесом Хирша = 43
...
Навыки
C/C++; С#; Git; Python; Scripting: bash, Powershell, cmake, python; Android: Kotlin, Termux, Compose; Desktop: Qt, DevExpress, Compose, Gtk#; Базы данных; Docker
...
Рекомендации
CERN
Rene Brun (Rene.Brun@cern.ch) (programmer)
...
Свою лимонную С++ LOC - я давно написал.

...
- DevOps (кроссплатформенная сборка пакетов, ядра Linux, инфракструктуры их поддержки)    
...
### **"АО НПЦ ЭЛВЕС"** *(апрель 2025 — октябрь 2025)* 
...
- Создал кроссплатформенные системы с тысячами строк кода и тысячами пользователей  

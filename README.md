...
Валерий Онучин — соавтор ключевых публикаций коллаборации **PHENIX** на ускорителе RHIC (США), посвящённых:
- Изучению образования плотного партонного вещества в столкновениях ядер золота при √sNN = 200 ГэВ [[56]];
- Измерению подавления адронов с высоким поперечным импульсом — признака образования кварк-глюонной плазмы [[56]];
- Анализу эллиптического потока (elliptic flow) идентифицированных адронов как индикатора коллективного поведения вещества [[56]].

#### 2. **Физика нейтрино**
Участие в эксперименте **MINOS** (Fermilab, США):
- Измерение параметров осцилляций мюонных нейтрино на базе детекторов вблизи и вдали от источника [[44]];
...
- Измерение параметров Далитц-плота и поиск нарушения *CP*-инвариантности в распадах каонов [[22]].

#### 4. **Эксперимент «Гиперон-М» (ИФВЭ, У-70)**
- Разработка многокомпьютерного комплекса сбора данных на базе электроники стандартов **MISS** и **SUMMA** [[46]][[71]];
- Поиск модификации свойств ω-мезона в холодной ядерной материи [[70]];
- Исследование механизмов адрон-ядерных взаимодействий в положительном пучке ускорителя У-70 [[68]][[69]].
...
- **Более 13 800 цитирований**, [Индекс Хирша = 43](https://www.scopus.com/authid/detail.uri?authorId=8401982000).
...
- ИФВЭ: эксперимент "Комплекс Меченного Нейтрино", Гиперон-М

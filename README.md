...
- неудачная попытка кросс сборки Alt Workstation из-под qemu-e2k, по причине нерабочего состояния qemu-e2k
- кросс-сборка x86_64-aarch64 ядра Линукс, 6.10
  
 Технологии: qemu-aarch64, docker, bash. Конечный итог- 2 bash скрипта размером по 300 строк

- кросс-сборка АльтЛинукс с Mate Desktop под процессор Скиф (aarch64, ARM Cortex-A53)
- кросс-компиляция x86_64-e2k Alt Workstation с помощью компилятора lcc. В качестве примера был взят PDK от МЦСТ.

...
кросс-компиляция x86_64-e2k Alt Workstation с помощью компилятора lcc. В качестве примера был взят PDK от МЦСТ. Работа не была закончена. **ОИЯИ, Дубна, Московская область** *(январь 2022 — декабрь 2024)*  
...
- тысячи пентабайт записанных данных в формате ROOT/IO. Все данные с БАК записаны в этом формате.

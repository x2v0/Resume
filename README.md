...
**Специализация**  
- ~30 лет в профессии. Программист общего профиля: Linux (включая ядро 6.18), Windows, Android, Embedded/SoC (ARM8, aarch64), Эльбрус/e2k. C++, C#, Kotlin, Python, bash, Go, Rust, Ruby, JavaScript ... Make, CMake, Meson/Ninja, autotools/pkg-config, VS Studio, Android Studio, Eclipse ...  Win32, X11, GL, Vulkan, Qt, Winforms/WPF, DevExpress Forms, JetBrains Compose ... DirectShow, FFmpeg GStreamer, OpenCV ... TCP/IP, UDP, RTSP ... SQLite, MySQL, Maria DB, PostgeSQL .. docker, LXC ... PulseAudio, PipeWire, ALSA, HDA ...  ++ и тд. и тп.

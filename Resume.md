...
Был уволен по причине медленной работы. В свое оправдание могу сказать,чьт все поставленные передо мной задачи были для меня абсолютно новыми (не по моей специализации) + слабая поддержка коллег.
